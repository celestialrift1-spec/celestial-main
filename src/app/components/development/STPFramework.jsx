...
export default function UpcomingProducts() {
  ...
  return (
    <section
      ...
      className="py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28 relative overflow-hidden scroll-mt-[80px] sm:scroll-mt-[100px] w-full"
      style={{
    ...
    >
      ...
      <motion.div
        className="absolute top-0 right-0 w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] md:w-[600px] md:h-[600px] lg:w-[700px] lg:h-[700px] xl:w-[800px] xl:h-[800px] opacity-10"
      ...
      <motion.div
        className="absolute bottom-0 left-0 w-[250px] h-[250px] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] opacity-10"
        initial={{ opacity: 0, scale: 0.8 }}
        animate={
          isInView ? { opacity: 0.1, scale: 1 } : { opacity: 0, scale: 0.8 }
        }
      ...
      >
        {/* Header Section */}
        <motion.div
          className="text-center max-w-4xl mx-auto mb-12 sm:mb-16 md:mb-20 lg:mb-24"
          variants={fadeUp(0)}
        >
          <motion.div
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#27391C] tracking-tight leading-snug sm:leading-tight mb-4 sm:mb-6">
            Upcoming
          ...
          <p className="text-sm xs:text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto px-4">
            Discover our pipeline of innovative mobility solutions designed to
            transform urban transportation in India.
          </p>
        ...
        <motion.div
          variants={containerVariants}
          className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-16 sm:mb-20"
        >
          {upcomingProducts.map((product, index) => (
            ...
            >
              <div
                className="h-full p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl relative overflow-hidden group border-2 transition-all duration-300 hover:shadow-xl sm:hover:shadow-2xl"
                style={{
              ...
              >
                ...
                <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p
                      className="text-xs sm:text-sm font-semibold text-ellipsis overflow-hidden"
                      style={{ color: product.color }}
                    >
                      {product.subtitle}
                    </p>
                ...
                {/* Description */}
                <p className="text-xs xs:text-sm sm:text-base text-gray-600 mb-6 sm:mb-8 leading-relaxed">
                  {product.description}
                </p>
                ...
                <div className="grid grid-cols-1 xs:grid-cols-2 gap-2 sm:gap-3 mb-6 sm:mb-8">
                  {product.features.map((feature, idx) => (
                    ...
                    >
                      ...
                      <span className="text-xs xs:text-sm text-gray-700 line-clamp-2">
                        {feature.text}
                      </span>
                    </motion.div>
                  ))}
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div>
                    <h4
                      className="font-bold text-base sm:text-lg mb-2 sm:mb-3 flex items-center gap-2"
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                      {product.problemsSolved.map((problem, idx) => (
                        <motion.span
                          key={idx}
                          className="inline-block px-2 py-1 text-[10px] xs:text-xs font-medium rounded-full bg-red-50 text-red-700 border border-red-100 line-clamp-1"
                          initial={{ opacity: 0, scale: 0.8 }}
                          animate={
                            isInView
                              ? { opacity: 1, scale: 1 }
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                      {product.revenueStreams.map((stream, idx) => (
                        <motion.span
                          key={idx}
                          className="inline-block px-2 py-1 text-[10px] xs:text-xs font-medium rounded-full bg-green-50 text-green-700 border border-green-100 line-clamp-1"
                          initial={{ opacity: 0, scale: 0.8 }}
                          animate={
                            isInView
                              ? { opacity: 1, scale: 1 }
        ...
        <motion.div
          ...
          className="max-w-full sm:max-w-4xl mx-auto px-2 sm:px-4 lg:px-8"
          ...
          <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 lg:p-12 border-2 border-[#B0DB9C] shadow-lg sm:shadow-xl">
            ...
            >
              ...
              <p className="text-xs sm:text-sm md:text-base text-gray-600 max-w-2xl mx-auto px-2">
                Join us in building India's safest, greenest last-mile mobility
                network
              </p>
            </motion.div>

            {/* Flex layout for Funding Ask, Pre-money Valuation, and Scalable Model */}
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-10 justify-center">
              {[
                { label: "Funding Ask", value: fundingDetails.amount },
                {
                  label: "Pre-money Valuation",
                  value: fundingDetails.valuation,
                },
                { label: "Scalable Model", value: "Market Ready" },
              ].map((item, index) => (
                <motion.div
                  key={index}
                  className="w-full sm:w-1/3 text-center p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl bg-white border border-gray-200"
                  ...
                  <motion.div
                    ...
                    animate={
                      isInView
                        ? {
                            scale: [1, 1.1, 1],
                            color: [DARK_GREEN, PRIMARY_GREEN, DARK_GREEN],
                          }
                        : {}
                    }
            ...
            {/* CTA Section */}
            <motion.div
              className="text-center mt-8 sm:mt-10 md:mt-12 pt-6 sm:pt-8 border-t border-gray-200"
              initial={{ opacity: 0 }}
              animate={isInView ? { opacity: 1 } : { opacity: 0 }}
              transition={{ duration: 0.6, delay: 1.2 }}
            >
              <p
                className="text-sm sm:text-base md:text-lg font-semibold mb-4 sm:mb-6"
                style={{ color: DARK_GREEN }}
              >
                Excited to partner with forward-thinking investors
              </p>
              <motion.a
                href="/contact"
                className="inline-flex items-center gap-2 px-5 sm:px-6 md:px-8 py-3 sm:py-4 text-sm sm:text-base md:text-lg font-bold text-white rounded-full"
                style={{ backgroundColor: DARK_GREEN }}
                whileHover={{
                  scale: 1.05,
                  boxShadow: `0 10px 25px ${PRIMARY_GREEN}40`,
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-3 sm:mt-4 px-2">
                For detailed discussions, pitch deck, or to explore this
                opportunity
              </p>
            </motion.div>
          </div>
