...
const WhyChooseUs = () => {
    ...
    return (
       <motion.section
  id="why-choose-us"
  className="py-16 sm:py-16 md:py-20 bg-white font-sans"
  initial="hidden"
  whileInView="visible"
...
>
  <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
    ...
    <motion.div className="text-center mb-12 sm:mb-16 md:mb-20" variants={headerVariants}>
      <motion.h2
        className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#27391C] mb-3 sm:mb-4 tracking-tight leading-tight"
    ...
    <div className="md:grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center mt-12 sm:mt-16 md:mt-20">

      {/* Image Panel for md+ screens */}
      <motion.div
        className="relative w-full max-w-md md:max-w-[500px] h-[360px] sm:h-[420px] md:h-[580px] overflow-hidden rounded-3xl shadow-2xl bg-[#27391C] p-6 sm:p-8 mb-8 md:mb-0 hidden md:flex flex-col justify-center items-center"
      ...
      >
        ...
        <div className="relative z-10 text-white flex flex-col items-center justify-center h-full mt-24 sm:mt-32 md:mt-40">

          <motion.h3
            className="text-2xl sm:text-3xl md:text-3xl lg:text-3xl font-black text-white text-center mb-2 sm:mb-3 leading-tight"
          ...
          <motion.p
            className="text-sm sm:text-base md:text-lg text-[#B0DB9C] font-medium text-center max-w-[200px] sm:max-w-xs md:max-w-sm"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="flex space-x-3 sm:space-x-4 mt-4 sm:mt-6">
            <motion.div
              className="p-2 sm:p-3 bg-[#B0DB9C] rounded-full"
              initial={{ opacity: 0, scale: 0.5 }}
              whileInView={{ opacity: 1, scale: 1 }}
              transition={{ delay: 0.9, duration: 0.4 }}
              viewport={{ once: true }} 
            >
              <Icon path="users" className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }} 
            >
              <Icon path="briefcase" className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }} 
            >
              <Icon path="clock" className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
            </motion.div>
          </div>
