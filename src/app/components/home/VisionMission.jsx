...
const VisionMission = () => {
    ...
    return (
        <motion.section
    id="vision-mission"
    className="relative py-10 sm:py-14 bg-gradient-to-b from-gray-50 via-white to-gray-50 text-gray-800 selection:bg-[#B0DB9C] selection:text-[#27391C] font-sans overflow-hidden"
    initial="hidden"
    animate="visible"
...
>
    ...
    <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
        <motion.div
            className="absolute top-16 left-5 sm:top-20 sm:left-10 w-40 h-40 sm:w-[400px] sm:h-[400px] bg-[#B0DB9C]/4 rounded-full blur-3xl"
            animate={{ scale: [1, 1.2, 1], x: [0, 30, 0], y: [0, -30, 0] }}
            transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
            className="absolute bottom-16 right-5 sm:bottom-20 sm:right-10 w-40 h-40 sm:w-[400px] sm:h-[400px] bg-[#27391C]/4 rounded-full blur-3xl"
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        {/* Header Section */}
        <motion.div className="text-center mb-10 sm:mb-16" variants={sectionVariants}>

            <motion.div
                className="inline-flex items-center space-x-1.5 sm:space-x-2 px-3 sm:px-6 py-1 sm:py-2 bg-[#B0DB9C]/10 border-2 border-[#B0DB9C]/50 rounded-full mb-4 sm:mb-6"
                variants={itemVariants}
            >
                <div className="w-2 h-2 bg-[#B0DB9C] rounded-full animate-pulse" />
                <span className="text-xs sm:text-sm font-bold text-[#27391C] uppercase tracking-wide">Our Direction</span>
            </motion.div>

            <motion.div className="text-center mb-12 sm:mb-20 max-w-xl sm:max-w-3xl mx-auto" variants={headerVariants}>

                <h2
                    className="text-2xl sm:text-3xl lg:text-5xl font-extrabold text-[#27391C] tracking-tight leading-tight mb-4 sm:mb-5"
                >
                ...
                <motion.p
                    className="text-sm sm:text-base md:text-lg text-gray-600 font-semibold max-w-md sm:max-w-2xl mx-auto"
                    variants={itemVariants}
                >
                    Guiding our journey towards excellence and sustainable growth
                </motion.p>
                <motion.div
                    className="w-20 sm:w-24 h-1.5 mx-auto bg-gradient-to-r from-[#B0DB9C] to-[#27391C] mt-6 sm:mt-8 rounded-full"
                    initial={{ width: 0 }}
        ...
        <motion.div className="mt-10 sm:mt-16 flex justify-center" variants={itemVariants}>
            <div className="flex items-center space-x-2 sm:space-x-4">
                <div className="w-12 sm:w-16 h-1 bg-gradient-to-r from-transparent to-[#B0DB9C] rounded-full" />
                <motion.div
                    className="w-2 sm:w-3 h-2 sm:h-3 bg-[#B0DB9C] rounded-full"
                    animate={{ scale: [1, 1.5, 1], opacity: [1, 0.5, 1] }}
                    transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
                />
                <div className="w-12 sm:w-16 h-1 bg-gradient-to-l from-transparent to-[#27391C] rounded-full" />
            </div>
        </motion.div>
