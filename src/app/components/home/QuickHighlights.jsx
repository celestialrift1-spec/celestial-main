...
const QuickHighlights = () => {
    ...
    return (
        <motion.section
    id="quick-highlights"
    className="relative py-10 sm:py-12 bg-gradient-to-b from-white via-gray-50 to-white text-gray-800 selection:bg-[#B0DB9C] selection:text-[#27391C] font-sans overflow-hidden"
    initial="hidden"
    animate="visible"  
...
>
    ...
    <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
        <motion.div
            className="absolute top-24 sm:top-32 right-5 sm:right-20 w-40 h-40 sm:w-[500px] sm:h-[500px] bg-[#B0DB9C]/5 rounded-full blur-3xl"
            animate={{
                scale: [1, 1.15, 1],
                opacity: [0.3, 0.5, 0.3],
                x: [0, 30, 0],
        ...
        />
        <motion.div
            className="absolute bottom-24 sm:bottom-32 left-5 sm:left-20 w-40 h-40 sm:w-[500px] sm:h-[500px] bg-[#27391C]/5 rounded-full blur-3xl"
            animate={{
                scale: [1, 1.2, 1],
                opacity: [0.2, 0.4, 0.2],
                x: [0, -30, 0],
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        <motion.div className="text-center mb-12 sm:mb-20" variants={sectionVariants}>
            <motion.div
                className="inline-flex items-center space-x-2 sm:space-x-3 px-4 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-[#B0DB9C]/10 via-[#B0DB9C]/5 to-transparent border-2 border-[#B0DB9C]/50 rounded-full mb-6 sm:mb-8 backdrop-blur-sm"
            ...
            >
                ...
                >
                    <svg
                        className="w-4 sm:w-5 h-4 sm:h-5 text-[#27391C]"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                    >
                        <path
                ...
                <span className="text-xs sm:text-sm font-extrabold text-[#27391C] uppercase tracking-wider">
                    Why Choose Us
                </span>
            </motion.div>
        ...
        <motion.div
            className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10 lg:gap-12 max-w-6xl mx-auto mb-16 sm:mb-24"
            variants={sectionVariants}
        >
